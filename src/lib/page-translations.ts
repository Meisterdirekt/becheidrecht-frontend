...
export interface PageT {
  ...
  roiSectionLabel: string;
  roiSectionTitle: string;
  roiSectionDesc: string;
  integrationSectionLabel: string;
  integrationSectionTitle: string;
  integration1Title: string; integration1Desc: string;
  integration2Title: string; integration2Desc: string;
  integration3Title: string; integration3Desc: string;
  demoCTALabel: string;
  demoCTATitle: string;
  demoCTAText: string;
...
const DE: PageT = {
  ...
  text: "Software-Tool zur technischen Analyse von Bescheiden – findet Unstimmigkeiten und bereitet Daten strukturiert auf.",
  button: "Bescheid analysieren",
  consent: "Ich willige ein, dass meine Daten zur technischen Analyse verarbeitet werden. Mir ist bekannt, dass dies keine Rechtsberatung ist und keinen Anwalt ersetzt. Ich habe die Datenschutzinformationen gelesen.",
  ...
  consentLetter: "Ich willige ein, dass meine Daten zur technischen Analyse verarbeitet werden. Mir ist bekannt, dass dies keine Rechtsberatung ist und keinen Anwalt ersetzt.",
  btnGenerateLetter: "Musterschreiben generieren",
  ...
  trustSofort: "Analyse in Minuten",
  trustPrice: "Team-Lizenzen ab 199 €/Monat",
  sectionWhatWeOffer: "Was wir bieten",
  sectionAnalyseWriteSecure: "Technische Analyse. Strukturierte Aufbereitung. Datenschutz.",
  feature1Title: "Technische Fehlerprüfung",
  feature1Desc: "Automatisierte Prüfung auf formelle Unstimmigkeiten, fehlende Angaben und Rechenfehler in 16 Rechtsgebieten.",
  feature2Title: "Musterschreiben-Vorlage",
  feature2Desc: "Automatisch generierte Vorlage als Basis – keine fertige Rechtsschrift, sondern Orientierung für das Gespräch mit Ihrem Anwalt.",
  feature3Title: "DSGVO by Design",
  feature3Desc: "Vollständige Pseudonymisierung vor jeder Analyse. Daten verlassen Ihre Einrichtung nicht im Klartext.",
  sectionPrices: "Team-Lizenzen",
  sectionTransparentPrices: "Transparente Preise für Einrichtungen",
  recommended: "EMPFOHLEN",
  pricingBasicName: "Starter",
  pricingBasicPrice: "249 €",
  pricingBasicF1: "1 Nutzerzugang",
  pricingBasicF2: "100 Analysen / Monat",
  pricingBasicF3: "Automatische Pseudonymisierung",
  pricingBasicCta: "Demo starten",
  pricingStandardName: "Team",
  pricingStandardPrice: "499 €",
  pricingStandardF1: "Bis 3 Nutzerzugänge",
  ...
  pricingProPrice: "899 €",
  pricingProF1: "Bis 10 Nutzerzugänge",
  pricingProF2: "1.000 Analysen / Monat",
  ...
  footerAgb: "AGB",
  footerDisclaimer: "Technische Dokumentenanalyse – kein Ersatz für Rechtsberatung gem. § 2 RDG.",
  footerCopyright: "© 2026 BescheidRecht – Technische Dokumentenanalyse, keine Rechtsberatung.",
  ...
  stat3Val: "Minuten", stat3Lbl: "Analysezeit pro Bescheid",
  stat4Val: "DSGVO", stat4Lbl: "Art. 25 Privacy by Design",
  workflowSectionLabel: "So einfach geht es",
  workflowSectionTitle: "In 3 Schritten zum Schreiben-Entwurf",
  ...
  workflow2Title: "KI analysiert in Minuten",
  workflow2Desc: "Spezialisierte KI-Agenten prüfen auf 130+ Fehlertypen aus 16 Rechtsgebieten — mit Fristberechnung und Rechtsbasis.",
  workflow3Title: "Schreiben exportieren",
  workflow3Desc: "Direkt verwendbarer Schreiben-Entwurf als DIN A4 PDF. Fachkraft prüft, unterschreibt — und der Klient erhält sein Musterschreiben.",
  roiSectionLabel: "Einsparung berechnen",
  roiSectionTitle: "Was spart Ihre Einrichtung?",
  roiSectionDesc: "Stellen Sie die Regler auf Ihre Einrichtungsgröße ein — der ROI berechnet sich automatisch.",
  integrationSectionLabel: "Einfache Integration",
  integrationSectionTitle: "So nutzen Einrichtungen BescheidRecht",
  integration1Title: "Zugang einrichten",
  integration1Desc: "Ihr Team erhält einen gemeinsamen Einrichtungs-Account. Kein IT-Projekt, keine Installation — Browser genügt.",
  integration2Title: "Berater schulen",
  integration2Desc: "15 Minuten Einführung reichen. Bescheid hochladen, Analyse lesen, Musterschreiben nutzen — fertig.",
  integration3Title: "Im Alltag einsetzen",
  integration3Desc: "Bescheide direkt im Beratungsgespräch prüfen. Fehler erkennen, Fristen sichern, Widerspruch vorbereiten.",
...
const EN: PageT = {
  ...
  trustSofort: "Analysis in minutes",
  ...
  feature2Title: "Letters in Minutes",
  ...
  pricingBasicF2: "100 analyses / month",
  ...
  pricingProF2: "1,000 analyses / month",
  ...
  stat3Val: "Minutes", stat3Lbl: "Analysis time per notice",
  ...
  workflow2Title: "AI analyses in minutes",
  workflow2Desc: "Specialised AI agents check for 130+ error types across 16 areas of law — with deadline calculation and legal basis.",
  ...
  roiSectionLabel: "Calculate savings",
  roiSectionTitle: "What does your organisation save?",
  roiSectionDesc: "Adjust the sliders to your organisation's size — the ROI calculates automatically.",
  integrationSectionLabel: "Easy integration",
  integrationSectionTitle: "How organisations use BescheidRecht",
  integration1Title: "Set up access",
  integration1Desc: "Your team gets a shared organisation account. No IT project, no installation — a browser is all you need.",
  integration2Title: "Train advisors",
  integration2Desc: "15 minutes of onboarding is enough. Upload notice, read analysis, use template letter — done.",
  integration3Title: "Use daily",
  integration3Desc: "Check notices directly during client meetings. Spot errors, secure deadlines, prepare objections.",
...
const RU: PageT = {
  ...
  stat3Val: "Минуты", stat3Lbl: "Время анализа на решение",
  ...
  workflow2Title: "ИИ анализирует за минуты",
  workflow2Desc: "Специализированные ИИ-агенты проверяют 130+ типов ошибок в 16 правовых областях.",
  workflow3Title: "Экспорт письма",
  workflow3Desc: "Готовое к использованию возражение в DIN A4 PDF.",
  roiSectionLabel: "Рассчитать экономию",
  roiSectionTitle: "Сколько экономит ваша организация?",
  roiSectionDesc: "Настройте ползунки под размер вашей организации — ROI рассчитается автоматически.",
  integrationSectionLabel: "Простая интеграция",
  integrationSectionTitle: "Как организации используют BescheidRecht",
  integration1Title: "Настроить доступ",
  integration1Desc: "Ваша команда получает общий аккаунт. Никаких IT-проектов, установки не нужно — достаточно браузера.",
  integration2Title: "Обучить консультантов",
  integration2Desc: "15 минут введения достаточно. Загрузить решение, прочитать анализ, использовать шаблон — готово.",
  integration3Title: "Использовать ежедневно",
  integration3Desc: "Проверяйте решения прямо во время консультации. Находите ошибки, соблюдайте сроки, готовьте возражения.",
...
const AR: PageT = {
  ...
  stat3Val: "دقائق", stat3Lbl: "وقت التحليل لكل قرار",
  ...
  workflow2Title: "الذكاء الاصطناعي يحلل في دقائق",
  workflow2Desc: "وكلاء ذكاء اصطناعي متخصصون يفحصون 130+ نوع خطأ في 16 مجالاً قانونياً.",
  workflow3Title: "تصدير الخطاب",
  workflow3Desc: "اعتراض جاهز للاستخدام كـ PDF. يراجع المتخصص ويوقع — ويتلقى العميل اعتراضه.",
  roiSectionLabel: "احسب التوفير",
  roiSectionTitle: "ما الذي توفره مؤسستك?",
  roiSectionDesc: "اضبط أشرطة التمرير حسب حجم مؤسستك — يُحسب العائد تلقائياً.",
  integrationSectionLabel: "تكامل سهل",
  integrationSectionTitle: "كيف تستخدم المؤسسات BescheidRecht",
  integration1Title: "إعداد الوصول",
  integration1Desc: "يحصل فريقك على حساب مشترك. لا حاجة لمشروع تقني أو تثبيت — المتصفح يكفي.",
  integration2Title: "تدريب المستشارين",
  integration2Desc: "15 دقيقة تكفي للتعريف. رفع القرار، قراءة التحليل، استخدام النموذج — انتهى.",
  integration3Title: "الاستخدام اليومي",
  integration3Desc: "فحص القرارات مباشرة أثناء الاستشارة. اكتشاف الأخطاء، تأمين المواعيد، تحضير الاعتراضات.",
...
const TR: PageT = {
  ...
  trustPrice: "Takım lisansları 199 €/ay'dan",
  ...
  stat3Val: "Dakika", stat3Lbl: "Karar başına analiz süresi",
  ...
  workflow2Title: "YZ dakikalar içinde analiz eder",
  workflow2Desc: "Uzman YZ ajanları 16 hukuk alanında 130+ hata türünü kontrol eder.",
  ...
  roiSectionLabel: "Tasarrufu hesaplayın",
  roiSectionTitle: "Kurumunuz ne tasarruf ediyor?",
  roiSectionDesc: "Kaydırıcıları kurum büyüklüğünüze göre ayarlayın — ROI otomatik hesaplanır.",
  integrationSectionLabel: "Kolay entegrasyon",
  integrationSectionTitle: "Kurumlar BescheidRecht'i nasıl kullanıyor",
  integration1Title: "Erişim ayarla",
  integration1Desc: "Ekibiniz ortak bir kurum hesabı alır. BT projesi veya kurulum gerekmez — tarayıcı yeterli.",
  integration2Title: "Danışmanları eğit",
  integration2Desc: "15 dakikalık tanıtım yeterli. Kararı yükle, analizi oku, şablonu kullan — bitti.",
  integration3Title: "Günlük kullanım",
  integration3Desc: "Danışma sırasında kararları doğrudan kontrol edin. Hataları tespit edin, süreleri güvence altına alın, itirazları hazırlayın.",
  demoCTALabel: "Kurumunuz için",
  demoCTATitle: "Kurumunuzda kullanıma hazır mısınız?",
  demoCTAText: "BescheidRecht'in iş akışlarınıza nasıl uyduğunu 30 dakikada göstereceğiz. Ücretsiz, bağlayıcı değil.",
