...
const DE: PageT = {
  ...
  btnGenerateLetter: "Musterschreiben-Vorlage generieren",
  ...
  footerAgb: "AGB",
  footerDisclaimer: "Technische Dokumentenanalyse – KEINE Rechtsberatung. Wir sind keine Rechtsanwälte. Diese Software ersetzt keine anwaltliche Beratung.",
