      ...
      <div className="max-w-4xl mx-auto px-6 py-20 flex-grow">
        ...
        <section className="space-y-12 text-white/70 text-sm leading-relaxed">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-8">
            <h2 className="text-white font-bold uppercase tracking-widest text-xs mb-4">1. Geltungsbereich und Vertragspartner</h2>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-8">
            <h2 className="text-white font-bold uppercase tracking-widest text-xs mb-4">2. Vertragsschluss</h2>
            <p className="text-white/90">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-8">
            <h2 className="text-white font-bold uppercase tracking-widest text-xs mb-4">3. Leistungsumfang</h2>
            <p className="text-white/90">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-8">
            <h2 className="text-white font-bold uppercase tracking-widest text-xs mb-4">4. Widerrufsrecht (Verbraucher)</h2>
            <p className="text-white/90 mb-4">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-8">
            <h2 className="text-white font-bold uppercase tracking-widest text-xs mb-4">6. Nutzung, Konto, Sperrung</h2>
            <p className="text-white/90">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-8">
            <h2 className="text-white font-bold uppercase tracking-widest text-xs mb-4">7. Haftung</h2>
            <p className="text-white/90 mb-4">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-8">
            <h2 className="text-white font-bold uppercase tracking-widest text-xs mb-4">8. Urheberrecht und Nutzungsrechte</h2>
            <p className="text-white/90">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-8">
            <h2 className="text-white font-bold uppercase tracking-widest text-xs mb-4">9. Änderungen der AGB und des Angebots</h2>
            <p className="text-white/90">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-8">
            <h2 className="text-white font-bold uppercase tracking-widest text-xs mb-4">10. Schlussbestimmungen</h2>
            <p className="text-white/90 mb-4">
