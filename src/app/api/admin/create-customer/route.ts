...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    if (inviteError || !inviteData?.user) {
      ...
      reportError(new Error(msg), { context: "admin-create-customer" });
    ...
    if (updateError) {
      reportError(new Error(updateError.message), { context: "admin-create-customer" });
      return NextResponse.json(
    ...
    reportError(error instanceof Error ? error : new Error(String(error)), { context: "admin-create-customer" });
