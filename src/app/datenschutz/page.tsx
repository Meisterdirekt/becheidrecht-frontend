      ...
      <div className="max-w-4xl mx-auto px-6 py-20 flex-grow">
        ...
        <section className="space-y-12 text-[var(--text-muted)] text-sm leading-relaxed">
          ...
          <div className="rounded-2xl border border-[var(--accent)]/30 bg-[var(--accent)]/10 p-8">
            ...
            <p className="text-[var(--text)] mb-4">
              Die Analyse erfolgt primär über <strong>Anthropic, PBC (USA)</strong> – Claude-KI-Modelle – sowie als technischen Fallback über <strong>OpenAI LLC (USA)</strong>. Für die Recherche relevanter Rechtsgrundlagen kann ergänzend <strong>Tavily Inc. (USA)</strong> eingesetzt werden; dabei werden ausschließlich pseudonymisierte Textauszüge übermittelt. Der pseudonymisierte Text wird zur Verarbeitung an den jeweils eingesetzten Dienstleister übertragen. Rechtsgrundlage: Art. 6 Abs. 1 lit. a DSGVO (Ihre Einwilligung vor dem Upload) sowie Art. 49 Abs. 1 lit. a DSGVO (Drittlandübermittlung in die USA mit Ihrer Einwilligung). Mit Anthropic, OpenAI und Tavily bestehen Auftragsverarbeitungsverträge gemäß Art. 28 DSGVO.
            </p>
