      ...
      <div className="max-w-4xl mx-auto px-6 py-20 flex-grow">
        ...
        <section className="space-y-12 text-[var(--text-muted)] text-sm leading-relaxed">
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-8">
            <h2 className="text-[var(--text)] font-bold uppercase tracking-widest text-xs mb-4">Angaben gemäß § 5 DDG</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-8">
              <h2 className="text-[var(--text)] font-bold uppercase tracking-widest text-xs mb-4">Kontakt</h2>
            ...
            <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-8">
              <h2 className="text-[var(--text)] font-bold uppercase tracking-widest text-xs mb-4">Verantwortlich für den Inhalt</h2>
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-8">
            <h2 className="text-[var(--text)] font-bold uppercase tracking-widest text-xs mb-4">EU-Streitschlichtung</h2>
            <p className="text-[var(--text)]">
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-8">
            <h2 className="text-[var(--text)] font-bold uppercase tracking-widest text-xs mb-4">Haftung für Inhalte</h2>
            <p className="text-[var(--text)]">
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-8">
            <h2 className="text-[var(--text)] font-bold uppercase tracking-widest text-xs mb-4">Haftung für Links</h2>
            <p className="text-[var(--text)]">
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-8">
            <h2 className="text-[var(--text)] font-bold uppercase tracking-widest text-xs mb-4">Urheberrecht</h2>
            <p className="text-[var(--text)]">
