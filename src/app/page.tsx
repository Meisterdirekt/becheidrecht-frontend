      ...
      <main className="max-w-7xl mx-auto pt-16 px-6 pb-24 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end mb-16 max-w-6xl mx-auto text-left">
          {[
            ...
            { name: "Plus", price: "17,90 €", color: "bg-blue-600 border-blue-400 scale-105 z-10 shadow-2xl", high: true },
            { name: "Sozial PRO", price: "49 €", color: "bg-[#001a33] border-white/10" },
            { name: "Business", price: "99 €", color: "bg-[#001a33] border-white/10" }
          ].map((p, i) => (
