...
INSERT INTO urteile (gericht, aktenzeichen, entscheidungsdatum, leitsatz, rechtsgebiet, stichwort, relevanz_score) VALUES
...
('BSG', 'B 11 AL 35/03 R', '2005-02-17',
 ...
 'SGB III', ARRAY['Sperrzeit', '§ 159 SGB III', 'Arbeitsaufgabe', 'wichtiger Grund', 'Eigenkündigung'], 5),
...
('BSG', 'B 11 AL 7/08 R', '2009-02-25',
 ...
 'SGB III', ARRAY['Bemessungsentgelt', '§ 150 SGB III', 'ALG-Berechnung', 'Einmalzahlungen'], 4),
...
('BSG', 'B 11 AL 43/04 R', '2005-11-29',
 ...
 'SGB III', ARRAY['Anwartschaftszeit', '§ 142 SGB III', 'Rahmenfrist', 'Versicherungspflicht'], 4)
...
('BSG', 'B 13 R 129/15 R', '2017-05-24',
 ...
 'SGB VI', ARRAY['Erwerbsminderungsrente', '§ 43 SGB VI', 'volle Erwerbsminderung', '3-Stunden-Grenze'], 5),
...
('BSG', 'B 5 R 8/16 R', '2018-03-14',
 ...
 'SGB VI', ARRAY['Rentenberechnung', 'Beitragszeiten', 'Kontenklärung', 'Entgeltpunkte'], 4),
...
('BSG', 'B 13 R 19/17 R', '2019-03-28',
 ...
 'SGB VI', ARRAY['Wartezeit', '§ 50 SGB VI', 'Kindererziehungszeiten', 'Anrechnungszeiten'], 4),
...
('BSG', 'B 5 RE 23/14 R', '2016-07-06',
 ...
 'SGB VI', ARRAY['Hinzuverdienst', '§ 96a SGB VI', 'Erwerbsminderungsrente', 'Hinzuverdienstgrenze'], 4)
...
('BSG', 'B 1 KR 37/14 R', '2016-03-08',
 ...
 'SGB V', ARRAY['Krankengeld', '§ 44 SGB V', 'Arbeitsunfähigkeit', 'ärztliche Feststellung', 'Lücke'], 5),
...
('BSG', 'B 3 KR 5/17 R', '2018-06-19',
 ...
 'SGB V', ARRAY['Hilfsmittel', '§ 33 SGB V', 'Wirtschaftlichkeitsgebot', 'Grundbedürfnisse'], 4),
...
('BSG', 'B 1 KR 26/17 R', '2019-01-30',
 ...
 'SGB V', ARRAY['Krankengeld', 'Meldelücke', '§ 49 SGB V', 'Arbeitsunfähigkeit'], 4)
...
('BSG', 'B 3 P 3/18 R', '2019-12-18',
 ...
 'SGB XI', ARRAY['Pflegegrad', '§ 15 SGB XI', 'Begutachtung', 'MDK', 'Selbstständigkeit'], 5),
...
('BSG', 'B 3 P 2/18 R', '2020-03-26',
 ...
 'SGB XI', ARRAY['Pflegegeld', '§ 37 SGB XI', 'Antragstellung', 'Rückwirkung', 'Pflegebedürftigkeit'], 4),
...
('BSG', 'B 3 P 5/19 R', '2021-05-06',
 ...
 'SGB XI', ARRAY['Verhinderungspflege', '§ 39 SGB XI', 'Ersatzpflege', 'Angehörige'], 4)
...
('BSG', 'B 2 U 4/18 R', '2019-06-06',
 ...
 'SGB VII', ARRAY['Arbeitsunfall', '§ 8 SGB VII', 'Kausalzusammenhang', 'versicherte Tätigkeit'], 5),
...
('BSG', 'B 2 U 13/17 R', '2018-11-20',
 ...
 'SGB VII', ARRAY['Wegeunfall', '§ 8 Abs. 2 SGB VII', 'unmittelbarer Weg', 'Unterbrechung'], 4),
...
('BSG', 'B 2 U 11/18 R', '2020-01-16',
 ...
 'SGB VII', ARRAY['MdE', '§ 56 SGB VII', 'Erwerbsfähigkeit', 'funktionelle Einschränkungen', 'Berufskrankheit'], 4)
...
('BSG', 'B 9 SB 1/18 R', '2020-02-06',
 ...
 'SGB IX', ARRAY['GdB', '§ 152 SGB IX', 'Versorgungsmedizinische Grundsätze', 'Funktionsbeeinträchtigungen'], 5),
...
('BSG', 'B 9 SB 2/19 R', '2020-12-16',
 ...
 'SGB IX', ARRAY['Merkzeichen G', '§ 229 SGB IX', 'Gehbehinderung', 'Ortsverkehr', 'Wegstrecke'], 4),
...
('BSG', 'B 9 SB 3/17 R', '2018-09-11',
 ...
 'SGB IX', ARRAY['GdB-Herabsetzung', '§ 48 SGB X', 'wesentliche Änderung', 'Neufeststellung'], 4)
...
('BSG', 'B 8 SO 12/16 R', '2018-02-22',
 ...
 'SGB XII', ARRAY['Grundsicherung im Alter', '§ 41 SGB XII', 'Altersgrenze', 'Unterhaltsrückgriff', '100.000 EUR'], 5),
...
('BSG', 'B 8 SO 20/13 R', '2015-04-23',
 ...
 'SGB XII', ARRAY['Hilfe zum Lebensunterhalt', '§ 27 SGB XII', 'nicht erwerbsfähig', 'Regelbedarf'], 4),
...
('BSG', 'B 8 SO 7/18 R', '2020-05-27',
 ...
 'SGB XII', ARRAY['Einkommensanrechnung', '§ 82 SGB XII', 'Absetzbeträge', 'Erwerbseinkommen'], 4)
...
('BSG', 'B 8 SO 4/18 R', '2020-06-25',
 ...
 'SGB IX', ARRAY['Eingliederungshilfe', '§ 90 SGB IX', 'Teilhabe', 'Behinderung'], 5),
...
('BSG', 'B 8 SO 1/19 R', '2020-10-28',
 ...
 'SGB IX', ARRAY['Persönliches Budget', '§ 29 SGB IX', 'Wahlrecht', 'Sachleistung', 'Geldleistung'], 4),
...
('BVerfG', '1 BvR 2853/17', '2020-01-29',
 ...
 'SGB IX', ARRAY['individuelle Bedarfsermittlung', 'Teilhabe', 'Eingliederungshilfe', 'Gruppenangebot'], 4)
...
('BVerwG', '5 C 24/12', '2013-10-24',
 ...
 'SGB VIII', ARRAY['Hilfe zur Erziehung', '§ 27 SGB VIII', 'erzieherischer Bedarf', 'Kindeswohl'], 5),
...
('BVerwG', '5 C 9/16', '2017-06-15',
 ...
 'SGB VIII', ARRAY['§ 35a SGB VIII', 'seelische Behinderung', 'Teilhabebeeinträchtigung', 'Kinder'], 4),
...
('BVerwG', '5 C 11/13', '2014-09-11',
 ...
 'SGB VIII', ARRAY['örtliche Zuständigkeit', '§ 86 SGB VIII', 'gewöhnlicher Aufenthalt', 'getrennt lebende Eltern'], 3)
...
('BSG', 'B 7 AY 1/18 R', '2019-11-12',
 ...
 'AsylbLG', ARRAY['Analogleistungen', '§ 2 AsylbLG', '18 Monate', 'SGB XII', 'Aufenthaltsdauer'], 4)
...
('BVerwG', '5 C 3/17', '2018-06-07',
 ...
 'BAföG', ARRAY['Vermögensfreibetrag', '§ 29 BAföG', 'Antragstellung', 'Vermögensverschiebung'], 4),
...
('BVerwG', '5 C 17/14', '2015-09-17',
 ...
 'BAföG', ARRAY['Förderungshöchstdauer', '§ 15a BAföG', 'Regelstudienzeit', 'Verlängerung', 'Krankheit'], 4),
...
('BVerwG', '5 C 10/18', '2019-11-21',
 ...
 'BAföG', ARRAY['Elterneinkommen', '§ 24 BAföG', 'Aktualisierungsantrag', 'Einkommensanrechnung'], 4)
...
('BSG', 'B 10 EG 3/18 R', '2019-12-05',
 ...
 'BEEG', ARRAY['Elterngeld-Berechnung', '§ 2 BEEG', 'Bemessungszeitraum', 'Einmalzahlungen', 'Nettoeinkommen'], 5),
...
('BSG', 'B 10 EG 8/17 R', '2019-02-28',
 ...
 'BEEG', ARRAY['Elterngeld', 'Selbstständige', 'Bemessungszeitraum', 'Gewinnermittlung'], 4),
...
('BSG', 'B 10 EG 6/18 R', '2020-03-19',
 ...
 'BEEG', ARRAY['ElterngeldPlus', '§ 4a BEEG', 'Teilzeitarbeit', 'Elternzeit', 'Kürzung'], 4)
...
('BFH', 'III R 22/13', '2015-09-03',
 ...
 'Kindergeld', ARRAY['Kindergeld', '§ 62 EStG', 'Haushaltszugehörigkeit', 'getrennt lebende Eltern'], 4),
...
('BFH', 'III R 1/18', '2019-07-18',
 ...
 'Kindergeld', ARRAY['Kindergeld', 'volljähriges Kind', 'Ausbildung', '§ 32 EStG', 'Studium'], 4),
...
('BFH', 'III R 52/13', '2015-02-26',
 ...
 'Kindergeld', ARRAY['Kinderzuschlag', '§ 6a BKGG', 'Mindesteinkommensgrenze', 'Familienbedarf'], 4)
...
('BVerwG', '5 C 25/17', '2019-03-14',
 ...
 'Wohngeld', ARRAY['Wohngeld', 'Mietenstufe', '§ 12 WoGG', 'Miethöchstbetrag', 'Berechnung'], 4),
...
('BVerwG', '5 C 19/18', '2019-11-14',
 ...
 'Wohngeld', ARRAY['Wohngeld', 'Vorrang', '§ 7 WoGG', 'SGB II', 'Transferleistungen'], 4),
...
('BVerwG', '5 C 2/16', '2017-04-27',
 ...
 'Wohngeld', ARRAY['Wohngeld', 'Einkommensermittlung', '§ 14 WoGG', 'Bruttoeinkommen', 'Abzüge'], 3)
...
('BVerwG', '5 C 32/12', '2014-01-16',
 ...
 'UVG', ARRAY['Unterhaltsvorschuss', '§ 1 UVG', 'alleinerziehend', 'keinen Unterhalt', 'Anspruchsvoraussetzungen'], 5),
...
('BVerwG', '5 C 4/15', '2016-10-20',
 ...
 'UVG', ARRAY['Unterhaltsvorschuss', '§ 2 UVG', 'Mindestunterhalt', 'Kindergeld', 'Berechnung'], 4),
...
('OVG NRW', '12 A 2541/19', '2020-09-17',
 ...
 'UVG', ARRAY['Unterhaltsvorschuss', 'Unterhaltszahlung', 'unregelmäßige Zahlungen', 'Wegfall'], 3)
...
('BSG', 'B 4 AS 44/15 R', '2017-04-25',
 ...
 'SGB X', ARRAY['§ 45 SGB X', 'Rücknahme', 'Vertrauensschutz', 'grobe Fahrlässigkeit', 'Beweislast'], 5),
...
('BSG', 'B 14 AS 13/15 R', '2016-09-29',
 ...
 'SGB X', ARRAY['§ 44 SGB X', 'Überprüfungsantrag', 'bestandskräftig', 'Korrektur', 'keine Frist'], 5),
...
('BSG', 'B 4 AS 12/14 R', '2015-06-17',
 ...
 'SGB X', ARRAY['§ 48 SGB X', 'Aufhebung', 'Erstattung', 'wesentliche Änderung', 'Berechnung'], 5)
